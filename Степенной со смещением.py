...
x = np.array(
    [1.85, 1.88, 1.88, 1.89, 2.25, 2.29, 2.29, 2.33, 2.43, 2.34, 2.52, 2.43, 1.77, 1.85, 1.82, 1.88, 2.24, 2.23, 2.23,
     ...
     1.96, 2.41, 2.47, 2.3, 2.37, 2.49, 2.59, 2.41, 2.61]) # Содержание гумуса по Тьюрину
y = np.array(
    [28.58, 31.23, 31.26, 32.02, 30.51, 32.75, 32.46, 34.32, 37.41626, 33.57125, 38.63887, 35.50919, 28.12, 30.8, 31.75,
     ...
     67.87, 61.54, 94.63]) # Среднеежегодные значения за 6 лет

x = x/1.724 # Переводим в органический углерод
y = y*6 # Вычисляем сумму за 6 лет
